...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'e@qollector.onmicrosoft.com',
  ...
  baseDirectory: process.env.BASE_DIRECTORY || '/应用',
  ...
  protectedRoutes: ['/download', '/Demo/😎Another Private Folder Password qaq666888'],
